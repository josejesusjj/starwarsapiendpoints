...
@app.route('/favorite-add/planets/<int:user_id>/<int:planets_id>', methods=['GET','POST'])
...
@app.route('/favorite-delete/people/<int:id>', methods=['GET','POST'])
...
@app.route('/favorite-delete/planets/<int:id>', methods=['GET','POST'])
